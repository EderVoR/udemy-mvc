...
namespace LanchesMac.Migrations
{
    public partial class PopularLanches : Migration
    {
        ...
        {
            migrationBuilder.Sql(@"INSERT INTO Lanches(CategoriaId,DescricaoCurta,DescricaoLonga,EmEstoque,ImagemTumbnailUrl,ImagemUrl,IsLanchePreferido,Nome,Preco) 
                                VALUES(1,'Pão, hambúrger, ovo, presunto, queijo e batata palha','Delicioso pão de hambúrger com ovo frito; presunto e queijo de primeira qualidade acompanhado com batata palha',
        ...
        {
            migrationBuilder.Sql("DELETA FROM LANCHES");
        }
    }
}
